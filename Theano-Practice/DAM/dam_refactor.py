...
from nets_visualization import show_weight, \
    show_attention_weight, show_gru_weight
...
class DAM:
    def __init__(self, babi_train_raw, babi_test_raw, word2vec,
        ...
        self.W_a = util.normal_param(std=0.1, shape=(self.vocab_size, self.dim))
        ...
        if self.l2 > 0:
            self.loss_l2 = self.l2 * util.l2_reg(self.params)
        else:
            self.loss_l2 = 0

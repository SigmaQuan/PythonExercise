...
print("# get word size of each sentence of inputs and questions.")
...
print("# function for laoding batch data.")
...
print("# initialize DMN.")
dmn = DMN(config, word_dict)

# compile prediction and gate_activation
print("# compile prediction and gate_activation")
...
print("# Training : Train the model by prediction and gate activation.")
...
print("# Pratraining : Only train by gate activation.")
...
print("# Validation : Pre-evaluate the model by its prediction derived by 5% of TEST SET")
...
# An example question in test set
print("# An example question in test set")
